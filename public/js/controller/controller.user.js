angular.module('app').controller('signupCtrl', ['$scope', 'Users', 'Categories', 'post', 'comment', 'getAllPosts', 'getPostById',
    'getComments', 'loginUser', 'Authentication', 'UpdateUser', 'createpost', '$location',
    function($scope, Users, Categories, post, comment, getAllPosts, getPostById, getComments, loginUser, Authentication,
        UpdateUser, createpost, $location) {
